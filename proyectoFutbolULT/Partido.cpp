...
void Partido::Cargar(int nroPartido){
    ...
    if (_golesLocal > _golesVisitante) {
        _club.actualizarPuntos(_codClubLocal, 3);
        _club.actualizarPuntos(_codClubVisitante, 0);
    } else if (_golesLocal < _golesVisitante) {
        _club.actualizarPuntos(_codClubLocal, 0);
        _club.actualizarPuntos(_codClubVisitante, 3);
    } else {
        // empate
        _club.actualizarPuntos(_codClubLocal, 1);
        _club.actualizarPuntos(_codClubVisitante, 1);
    }
    ////////////////////////////////////////////////
    cout<<"FECHA DEL PARTIDO: "<<endl;
    fechaDePartido.Cargar();
